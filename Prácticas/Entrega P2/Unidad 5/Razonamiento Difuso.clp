...
;; b) Añadimos una variable nueva EDAD
(variable edad)     
)
...
(cd temperatura normal 36 36 37.1 37.4)   ; CAMBIADIO
...
(cd dosis baja 2 4 4 6.5)    ; CAMBIADO
(cd dosis media 6 7 7 8)     ; aproximadamente 7
(cd dosis alta 8 9 9 10)     ; aprximadamente 9

; AÑADIMOS LOS CONJUNTOS DIFUSOS PARA LA NUEVA VARIABLE EDAD
(cd edad joven 0 9 9 25)
(cd edad adulto 20 50 50 100)
)
...
;;; CAMBIO 
;;; Añadimos nuevas reglas que tambien utilicen esa variables
(regla 5 antecedente temperatura alta)
(regla 5 antecedente edad joven)
(regla 5 antecedente peso alto)
(regla 5 consecuente dosis bajo)
(regla 5 explicacion "Si la temperatura es alta, la edad es joven y el peso es alto, la dosis a aplicar es baja")
...
(regla 6 explicacion "Si la temperatura es alta, la edad es adulto y el peso es medio, la dosis a aplicar es alta")

(regla 7 antecedente temperatura intermedia)
(regla 7 antecedente edad adulto)
(regla 7 antecedente peso alto)
(regla 7 consecuente dosis media)
(regla 7 explicacion "Si la temperatura es intermedia, la edad es adulto y el peso es alto, la dosis a aplicar es media")
)
...
;;; CAMBIO: AÑADIMOS LA PREGUNTA DE LA EDAD
(defrule pregunta3
(declare (salience 1))
=>
(printout t "Edad: ")
